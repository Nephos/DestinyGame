...
class SquaresControllerTest < ActionController::TestCase
  ...
  test "should create square" do
    assert_difference('Square.count') do
      post :create, square: { description: @square.description, image: @square.image, position: @square.position, title: @square.title }
    end
  ...
  test "should update square" do
    patch :update, id: @square, square: { description: @square.description, image: @square.image, position: @square.position, title: @square.title }
    assert_redirected_to square_path(assigns(:square))
  end
